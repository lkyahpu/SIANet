...
def mask_to_onehot(mask, num_classes):
    """
    Converts a segmentation masks (H,W) to (K,H,W) where the last dim is a one
    hot encoding vector
...
def onehot_to_multiclass_edges(mask, radius, num_classes):
    """
    Converts a segmentation masks (K,H,W) to an edgemap (K,H,W)
...
def onehot_to_binary_edges(mask, radius, num_classes):
    """
    Converts a segmentation masks (K,H,W) to a binary edgemap (H,W)
