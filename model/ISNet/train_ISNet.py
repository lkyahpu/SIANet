...
class Trainer(object):
    ...
    def validation(self, epoch):
        ...
        self.writer.add_image('input images', img_grid_i, global_step=None)  # j 表示feature map数
        img_grid_o = vutils.make_grid(output, normalize=True, scale_each=True, nrow=8)
        self.writer.add_image('output images', img_grid_o, global_step=None)  # j 表示feature map数
        ...
        self.writer.add_image('images gt', img_gt, global_step=None)  # j 表示feature map数
