...
class SirstDataset(Data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        if self.mode == 'train':
            ...
            # images, masks = self._sync_transform(images, masks)
    ...
    def _sync_transform(self, img, mask):
        ...
        data = {"image": img_1, "masks": mask_1}
        augmentation = strong_aug(p=1.0)
        augmented = augmentation(**data)  ## 数据增强
        img_1, mask_1 = augmented["image"], augmented["masks"]
