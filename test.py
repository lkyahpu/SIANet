...
parser.add_argument("--model_names", default=['SIANet'], type=list,
                    help="model_name: 'ACM', 'ALCNet', 'DNANet', 'ISNet', 'UIUNet', 'RDIAN', 'ISTDU-Net', 'U-Net', 'RISTDnet'")
parser.add_argument("--pth_dirs", default=['log/PRCVdata/SIANet_400.pth.tar'], type=list, help="checkpoint dir, default=None or ['NUDT-SIRST/ACM_400.pth.tar','NUAA-SIRST/ACM_400.pth.tar']")
...
parser.add_argument("--save_log", type=str, default='', help="path of saved .pth")
...
if __name__ == '__main__':
    ...
    if opt.pth_dirs == None:
        for i in range(len(opt.model_names)):
            ...
            opt.f.write(opt.model_name + '_50.pth.tar' + '\n')
            for dataset_name in opt.dataset_names:
                ...
                opt.pth_dir = opt.save_log + opt.dataset_name + '/' + opt.model_name + '_50.pth.tar'
                test()
            print('\n')
            opt.f.write('\n')
        opt.f.close()
